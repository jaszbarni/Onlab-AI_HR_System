...
from database_manager import check_permission
from utils.common import setup_page, check_user_initialized, initialize_session_state
from utils.campaigns_views import (
    generate_test_campaign, show_campaigns_list, show_create_campaign, show_edit_campaign,
...
with st.spinner("Loading..."):
    if st.session_state.campaigns_view == "list":
        ...
        show_campaign_forms()
    elif st.session_state.campaigns_view == "statistics":
        show_statistics()
